...
define( 'KINGINRIN_VERSION', '1.0.0' );

if ( ! function_exists( 'kinginrin_setup' ) ) {
	add_action( 'after_setup_theme', 'kinginrin_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function kinginrin_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'kinginrin' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'kinginrin' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in kinginrin_smart_content_width()
		 */
...
define('KINGINRIN_THEME_URL','https://wpkoi.com/kinginrin-wpkoi-wordpress-theme/','kinginrin');
define('KINGINRIN_WPKOI_AUTHOR_URL','https://wpkoi.com/','kinginrin');
define('KINGINRIN_DOCUMENTATION','https://wpkoi.com/docs/','kinginrin');